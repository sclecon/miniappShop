...
CREATE TABLE IF NOT EXISTS `auction` (
    ...
    `delay_price` FLOAT(10,2) DEFAULT '0.00' COMMENT '延时价格',
    `postage_price` FLOAT(10,2) DEFAULT '0.00' COMMENT '邮费价格',
    `commission_price` FLOAT(10,2) DEFAULT '0.00' COMMENT '佣金价格',
